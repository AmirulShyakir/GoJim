...
const OnboardingLoggedOut = ({ navigation }) => (
	<Onboarding
		...
		pages={[
			...
			},
			{
				...
				image: (
					<Image testID="page2" source={require("../assets/SearchForFacilityFINAL.png")} />
				),
			...
			},
			{
				...
				title: "JUST BOOK IT.",
				subtitle:
					"Select date and available timeslot. \n And thats pretty much it.",
			},
			{
				...
				subtitle:
					"Okay shawty, one's company, two's a crowd and three's a party! Enter event details and publish.",
			},
			{
				...
				title: "JOIN EVENTS.",
				subtitle:
					"Fancy a quick battle? Or perhaps a study date? There's always something fresh in the Events tab. ASSC who?",
			},
			{
...
export default OnboardingLoggedOut;
